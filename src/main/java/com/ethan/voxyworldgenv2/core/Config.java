...
public final class Config {
    ...
    public static class ConfigData {
        ...
        // ticking on an empty server (ServerChunkCache.tick runs unconditionally from
        // ServerLevel.tick), but the mod's worker is otherwise entirely player-anchored, so
        // without this it simply idles. Rate-limited through maxChunksPerSecond like everything
        // else the worker dispatches.
