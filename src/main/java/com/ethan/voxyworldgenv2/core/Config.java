...
public final class Config {
    ...
    public static class ConfigData {
        ...
        // ticking on an empty server, but the worker is player-anchored, so without this it simply
        // idles. Rate-limited through maxChunksPerSecond like everything else.
    ...
    /**
     * The subset of settings an operator can push from the client. Kept as a fixed-shape record
     * because it is serialised on the wire: adding a component is a protocol change.
     */
     ...
     * the sender is a client: a value outside these bounds means a hand-crafted packet, not a UI
     * mistake. The bounds match the argument ranges VoxyGenCommand already enforces for the
     * equivalent /voxygen subcommands.
     */
