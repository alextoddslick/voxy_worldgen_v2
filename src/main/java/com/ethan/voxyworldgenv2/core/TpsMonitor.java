...
/**
 * Ported from unified's graduated version (flowed down as part of protocol-5 convergence): the
 * old binary trip point (a single 18-TPS threshold) snapped the worker from full speed to a dead
 * stop. This eases off starting at 22 TPS and only fully stops at 13 TPS (75ms/tick), scaling
 * linearly in between via {@link #loadFactor()} -- backs off earlier and more smoothly than the
 * single-threshold version this replaces.
 */
