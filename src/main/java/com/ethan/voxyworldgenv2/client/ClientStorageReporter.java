...
/**
 * Periodically tells the server how much disk Voxy's store for the CURRENT world occupies, so the
 * tab HUD can show "sent 6 GB, holding 3 GB on disk" per player.
 *
