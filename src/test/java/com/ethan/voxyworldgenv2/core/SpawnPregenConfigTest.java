...
class SpawnPregenConfigTest {
    ...
    /**
     * The radius is clamped to at least 1 at the use site (ChunkGenerationManager.dispatchSpawnPregen)
     * rather than validated here, because a hand-edited 0 must not turn into "generate nothing
     * forever" silently.
     */
    @Test
