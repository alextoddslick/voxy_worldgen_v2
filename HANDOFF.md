...
**This worktree is on `port/26.2`** (MC 26.2, Java 25) — *not* `backport/1.21.1`, whatever older
sections below say.
...
- Version **`2.6.0+mc26.2`**. The `+mc` suffix carries the Minecraft version, so it identifies the build
